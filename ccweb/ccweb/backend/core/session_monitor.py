...
class SessionMonitor:
    ...
    async def check_for_updates(self, active_session_ids: set[str]) -> list[NewMessage]:
        ...
        # Offsets must be persisted only AFTER delivery to the client (in
    ...
    async def _monitor_loop(self) -> None:
        ...
        while self._running:
            try:
                ...
                # Persist byte offsets AFTER delivering messages to the client.
                # This guarantees at-least-once delivery: if the server crashes
