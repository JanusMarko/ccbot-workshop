...
Forked from ccbot — removed Telegram expandable quote sentinels.
Collapsible content is handled by the React frontend, not by text markers.
...
class TranscriptParser:
    ...
    # No expandable quote sentinels — the React frontend handles collapsible rendering.

    @classmethod
    def _format_collapsible(cls, text: str) -> str:
        """Return text as-is. The frontend renders collapsible content."""
        return text
    ...
    def _format_tool_result_text(cls, text: str, tool_name: str | None = None) -> str:
        ...
        if tool_name == "Read":
            ...
            if line_count > 0:
                ...
                return stats + "\n" + cls._format_collapsible(text)
            return cls._format_collapsible(text)
            ...
            if msg_type == "assistant":
                ...
                for block in content:
                    ...
                    if btype == "text":
                        ...
                        if thinking_text:
                            quoted = cls._format_collapsible(thinking_text)
                            result.append(
                                ParsedEntry(
                                    role="assistant",
                                    text=quoted,
                                ...
                                if old_s and new_s:
                                    ...
                                    if diff_text:
                                        ...
                                        entry_text += (
                                            ...
                                            + stats
                                            + "\n"
                                            + cls._format_collapsible(diff_text)
                                        )
